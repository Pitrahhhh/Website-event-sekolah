...
<div class="col-md-10">
    ...
    <div class="mb-3">
          <label for="datetime" class="form-label">Tanggal & Jam Kegiatan</label>
          <input type="datetime-local" class="form-control @error ('datetime') is-invalid @enderror" id="datetime" name="datetime" required value="{{ old('datetime', $post->datetime) }}">
          @error ('datetime')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
